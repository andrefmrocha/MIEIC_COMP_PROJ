...
public class Main {
     ...
     * @param assemblerName - name of the file generated by the assembler
     */
    private static void generateClassFile(String assemblerName) {
        boolean isWindows = System.getProperty("os.name") //Check which OS you're using
        ...
        try {
            Process process = builder.start(); // Use a subprocess to execute the command
    ...
    /**
     * Checks the different optimizations existing in the code
     * @param args - the arguments passed in the command line
     * @return - name of the file to compile
     * @throws IllegalArgumentException - when any of arguments are not acceptable
     */
