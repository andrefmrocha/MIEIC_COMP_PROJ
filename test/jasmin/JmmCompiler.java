...
public class JmmCompiler {
    ...
    public static String compile(File jmm, String... args){
		...
		try {
			...
			throw new RuntimeException("Error with compiling jmm: " + e.getMessage(), e);
		}

		System.out.println(jmm.getAbsolutePath());
		String filename = SpecsIo.removeExtension(jmm.getAbsolutePath()) + ".j";
